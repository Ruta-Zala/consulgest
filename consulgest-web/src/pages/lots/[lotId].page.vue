		...
		<div class="grid gap-6 w-full lg:w-2/3 xl:w-9/12">
			...
			>
				<div class="w-full pt-4 flex flex-col gap-6 2xl:w-9/12">
					<CardHeader title="Dossier closure rate">
						<template #endTitle>
							<DatepickerInput
					...
					<template #afterTitle>
						<div class="flex items-center gap-4 border-l border-c-coral-blue">
							<span
								...
								>132</span
							>
							<span>CSV’s imported found</span>
						</div>
					</template>
					<template #endTitle>
						<div class="flex gap-4 flex-wrap">
							<Dropdown label="Debt collector">
								<DropdownItem>
		...
		<div class="w-full grid gap-6 lg:w-2/6 xl:w-3/12">
			<Card class="flex flex-col gap-5 p-4">
				<div class="flex justify-between">
					<h3 class="text-c-dark-blue text-lg font-medium">Lot/CSV Manager</h3>
				...
				<div class="flex gap-4 items-center">
					...
					<div class="flex flex-col gap-1">
						<h5 class="text-c-dark-blue text-xl font-medium">Sara Smith</h5>
						<span class="text-c-light-grey block text-sm"
							>sara.smith@consulgest.it</span
						>
						<span class="text-c-light-grey block text-sm">+000 000 000</span>
					</div>
				</div>
				<div
					class="bg-c-linear gap-2.5 rounded-lg p-2.5 flex items-center text-c-deep-blue"
				>
					<IconClock class="h-4 w-4" />
					<h5 class="text-sm font-semibold">
						Last updated: <span class="font-normal">Yesterday 18:00h</span>
					</h5>
				</div>
			</Card>
			<ChartCard
